...
namespace LocatingApp.Rpc.app_user
{
    ...
    {
        [Route(AppUserRoute.SingleListLocationLog), HttpPost]
        public async Task<List<AppUser_LocationLogDTO>> SingleListLocationLog([FromBody] AppUser_LocationLogFilterDTO AppUser_LocationLogFilterDTO)
        {
