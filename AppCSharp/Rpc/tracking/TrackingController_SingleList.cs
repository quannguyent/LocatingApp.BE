...
namespace LocatingApp.Rpc.tracking
{
    ...
    {
        [Route(TrackingRoute.SingleListPlace), HttpPost]
        public async Task<List<Tracking_PlaceDTO>> SingleListPlace([FromBody] Tracking_PlaceFilterDTO Tracking_PlaceFilterDTO)
        {
        ...
        [Route(TrackingRoute.SingleListPlaceChecking), HttpPost]
        public async Task<List<Tracking_PlaceCheckingDTO>> SingleListPlaceChecking([FromBody] Tracking_PlaceCheckingFilterDTO Tracking_PlaceCheckingFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(TrackingRoute.SingleListAppUser), HttpPost]
        public async Task<List<Tracking_AppUserDTO>> SingleListAppUser([FromBody] Tracking_AppUserFilterDTO Tracking_AppUserFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
