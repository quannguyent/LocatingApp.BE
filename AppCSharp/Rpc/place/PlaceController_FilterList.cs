...
namespace LocatingApp.Rpc.place
{
    ...
    {
        [Route(PlaceRoute.FilterListPlaceGroup), HttpPost]
        public async Task<List<Place_PlaceGroupDTO>> FilterListPlaceGroup([FromBody] Place_PlaceGroupFilterDTO Place_PlaceGroupFilterDTO)
        {
