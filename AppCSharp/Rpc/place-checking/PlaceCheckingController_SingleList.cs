...
namespace LocatingApp.Rpc.place_checking
{
    ...
    {
        [Route(PlaceCheckingRoute.SingleListAppUser), HttpPost]
        public async Task<List<PlaceChecking_AppUserDTO>> SingleListAppUser([FromBody] PlaceChecking_AppUserFilterDTO PlaceChecking_AppUserFilterDTO)
        {
        ...
        [Route(PlaceCheckingRoute.SingleListPlace), HttpPost]
        public async Task<List<PlaceChecking_PlaceDTO>> SingleListPlace([FromBody] PlaceChecking_PlaceFilterDTO PlaceChecking_PlaceFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(PlaceCheckingRoute.SingleListCheckingStatus), HttpPost]
        public async Task<List<PlaceChecking_CheckingStatusDTO>> SingleListCheckingStatus([FromBody] PlaceChecking_CheckingStatusFilterDTO PlaceChecking_CheckingStatusFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
