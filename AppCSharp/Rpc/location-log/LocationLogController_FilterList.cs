...
namespace LocatingApp.Rpc.location_log
{
    ...
    {
        [Route(LocationLogRoute.FilterListAppUser), HttpPost]
        public async Task<List<LocationLog_AppUserDTO>> FilterListAppUser([FromBody] LocationLog_AppUserFilterDTO LocationLog_AppUserFilterDTO)
        {
        ...
        [Route(LocationLogRoute.FilterListLocationLog), HttpPost]
